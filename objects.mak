...
OBJS := auxil.o entire.o parser.o lex.o yygrammar.o sym_table.o utils.o       \
        ...
        dt_static_array_type.o dt_user_type.o                                 \
        ir_node.o ir_symbol.o ir_variable.o ir_function.o ir_code_block.o     \
        ir_statment.o ir_cast.o ir_constant.o ir_bool_constant.o              \
        ir_int_constant.o ir_uint_constant.o ir_char_constant.o               \
        ...
        ir_array.o ir_array_slice.o ir_array_cell.o ir_scalar.o               \
